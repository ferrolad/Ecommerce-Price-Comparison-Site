<?php
include "./display/privacy_policy_display.php";      
include "./CMS/include/database_config.php";
$display = new privacy_policy_display();
...
<head> 
  ...
  <meta property="og:title" content="Privacy Policy - Pricepony Philippines"/>
      ...
      <div id="header">
        ...
        <div id="content_page_detail">
         <div id="breadcrumb">
           ...
           <span class="pathway last">Privacy Policy</span>
         </div>
       </div>
     </div>
     <div class="clear"></div>
